...
const ProductEntity_1 = require("../model/entity/ProductEntity");
class ProductRepository {
    ...
    async insertProduct(name, price) {
        ...
        return new ProductEntity_1.ProductEntity(resultado.insertId, name, price);
    }
    ...
    async updateProduct(id, name, price) {
        ...
        return new ProductEntity_1.ProductEntity(id, name, price);
    }
